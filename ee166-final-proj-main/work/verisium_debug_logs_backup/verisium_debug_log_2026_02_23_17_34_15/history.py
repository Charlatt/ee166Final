...
# history.py generated at 2026/02/23 12:34:15
# host: dell52
# port: 34365
# launch command: indago -connect dc:dell52.eecs.tufts.edu:45725 -interactive
# #########################################################################
import time, os, sys
if 'self' not in globals():
    ...
    self = VerisiumDebugServer(VerisiumDebugArgs(
        ...
        port=34365,
        extra_args='-connect dc:dell52.eecs.tufts.edu:45725 -interactive'
    ))

# Verisium: Attempting to connect to Verisium server on host: localhost, port: 34365
# Verisium: **************************************************************************************
