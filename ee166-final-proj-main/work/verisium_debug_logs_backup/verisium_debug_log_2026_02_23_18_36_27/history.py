...
# history.py generated at 2026/02/23 13:30:11
# host: vm-hw07
# port: 42071
# launch command: indago -connect dc:vm-hw07.eecs.tufts.edu:43519 -interactive
# #########################################################################
import time, os, sys
if 'self' not in globals():
    ...
    self = VerisiumDebugServer(VerisiumDebugArgs(
        ...
        port=42071,
        extra_args='-connect dc:vm-hw07.eecs.tufts.edu:43519 -interactive'
    ))

# Verisium: Attempting to connect to Verisium server on host: localhost, port: 42071
# Verisium: **************************************************************************************
