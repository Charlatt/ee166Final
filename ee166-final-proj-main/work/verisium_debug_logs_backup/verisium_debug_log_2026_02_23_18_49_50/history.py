...
# history.py generated at 2026/02/23 13:40:08
# host: vm-hw07
# port: 38149
# launch command: indago -connect dc:vm-hw07.eecs.tufts.edu:42219 -interactive
# #########################################################################
import time, os, sys
if 'self' not in globals():
    ...
    self = VerisiumDebugServer(VerisiumDebugArgs(
        ...
        port=38149,
        extra_args='-connect dc:vm-hw07.eecs.tufts.edu:42219 -interactive'
    ))

# Verisium: Attempting to connect to Verisium server on host: localhost, port: 38149
# Verisium: **************************************************************************************
