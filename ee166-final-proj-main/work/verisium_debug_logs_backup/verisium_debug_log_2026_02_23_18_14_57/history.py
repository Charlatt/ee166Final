...
# history.py generated at 2026/02/23 13:14:57
# host: dell52
# port: 38537
# launch command: indago -connect dc:dell52.eecs.tufts.edu:46205 -interactive
# #########################################################################
import time, os, sys
if 'self' not in globals():
    ...
    self = VerisiumDebugServer(VerisiumDebugArgs(
        ...
        port=38537,
        extra_args='-connect dc:dell52.eecs.tufts.edu:46205 -interactive'
    ))

# Verisium: Attempting to connect to Verisium server on host: localhost, port: 38537
# Verisium: **************************************************************************************
