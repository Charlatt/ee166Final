...
# history.py generated at 2026/02/23 13:05:22
# host: dell52
# port: 35801
# launch command: indago -connect dc:dell52.eecs.tufts.edu:52917 -interactive
# #########################################################################
import time, os, sys
if 'self' not in globals():
    ...
    self = VerisiumDebugServer(VerisiumDebugArgs(
        ...
        port=35801,
        extra_args='-connect dc:dell52.eecs.tufts.edu:52917 -interactive'
    ))

# Verisium: Attempting to connect to Verisium server on host: localhost, port: 35801
# Verisium: **************************************************************************************
