...
# history.py generated at 2026/02/23 13:11:45
# host: dell52
# port: 40409
# launch command: indago -connect dc:dell52.eecs.tufts.edu:42649 -interactive
# #########################################################################
import time, os, sys
if 'self' not in globals():
    ...
    self = VerisiumDebugServer(VerisiumDebugArgs(
        ...
        port=40409,
        extra_args='-connect dc:dell52.eecs.tufts.edu:42649 -interactive'
    ))

# Verisium: Attempting to connect to Verisium server on host: localhost, port: 40409
# Verisium: **************************************************************************************
