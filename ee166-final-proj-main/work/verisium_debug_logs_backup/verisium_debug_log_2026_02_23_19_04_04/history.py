...
# history.py generated at 2026/02/23 14:03:44
# host: vm-hw07
# port: 35079
# launch command: indago -connect dc:vm-hw07.eecs.tufts.edu:46243 -interactive
# #########################################################################
import time, os, sys
if 'self' not in globals():
    ...
    self = VerisiumDebugServer(VerisiumDebugArgs(
        ...
        port=35079,
        extra_args='-connect dc:vm-hw07.eecs.tufts.edu:46243 -interactive'
    ))

# Verisium: Attempting to connect to Verisium server on host: localhost, port: 35079
# Verisium: **************************************************************************************
