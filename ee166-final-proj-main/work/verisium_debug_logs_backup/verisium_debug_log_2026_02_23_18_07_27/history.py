...
# history.py generated at 2026/02/23 13:07:27
# host: dell52
# port: 41351
# launch command: indago -connect dc:dell52.eecs.tufts.edu:57891 -interactive
# #########################################################################
import time, os, sys
if 'self' not in globals():
    ...
    self = VerisiumDebugServer(VerisiumDebugArgs(
        ...
        port=41351,
        extra_args='-connect dc:dell52.eecs.tufts.edu:57891 -interactive'
    ))

# Verisium: Attempting to connect to Verisium server on host: localhost, port: 41351
# Verisium: **************************************************************************************
