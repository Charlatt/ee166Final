...
# history.py generated at 2026/02/23 13:54:31
# host: vm-hw07
# port: 33609
# launch command: indago -connect dc:vm-hw07.eecs.tufts.edu:35087 -interactive
# #########################################################################
import time, os, sys
if 'self' not in globals():
    ...
    self = VerisiumDebugServer(VerisiumDebugArgs(
        ...
        port=33609,
        extra_args='-connect dc:vm-hw07.eecs.tufts.edu:35087 -interactive'
    ))

# Verisium: Attempting to connect to Verisium server on host: localhost, port: 33609
# Verisium: **************************************************************************************
