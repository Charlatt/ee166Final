...
# history.py generated at 2026/02/23 12:27:45
# host: dell52
# port: 44565
# launch command: indago -connect dc:dell52.eecs.tufts.edu:41971 -interactive
# #########################################################################
import time, os, sys
if 'self' not in globals():
    ...
    self = VerisiumDebugServer(VerisiumDebugArgs(
        ...
        port=44565,
        extra_args='-connect dc:dell52.eecs.tufts.edu:41971 -interactive'
    ))

# Verisium: Attempting to connect to Verisium server on host: localhost, port: 44565
# Verisium: **************************************************************************************
