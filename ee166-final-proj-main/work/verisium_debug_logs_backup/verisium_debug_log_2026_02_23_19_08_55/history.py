...
# history.py generated at 2026/02/23 14:08:55
# host: vm-hw07
# port: 36821
# launch command: indago -connect dc:vm-hw07.eecs.tufts.edu:44589 -interactive
# #########################################################################
import time, os, sys
if 'self' not in globals():
    ...
    self = VerisiumDebugServer(VerisiumDebugArgs(
        ...
        port=36821,
        extra_args='-connect dc:vm-hw07.eecs.tufts.edu:44589 -interactive'
    ))

# Verisium: Attempting to connect to Verisium server on host: localhost, port: 36821
# Verisium: **************************************************************************************
