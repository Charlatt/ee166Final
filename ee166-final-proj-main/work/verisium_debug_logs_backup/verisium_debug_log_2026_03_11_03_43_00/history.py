...
# history.py generated at 2026/03/10 23:43:00
# host: vm-hw05
# port: 41519
# launch command: indago -connect dc:vm-hw05.eecs.tufts.edu:55175 -interactive
# #########################################################################
import time, os, sys
if 'self' not in globals():
    ...
    self = VerisiumDebugServer(VerisiumDebugArgs(
        ...
        port=41519,
        extra_args='-connect dc:vm-hw05.eecs.tufts.edu:55175 -interactive'
    ))

# Verisium: Attempting to connect to Verisium server on host: localhost, port: 41519
# Verisium: **************************************************************************************
