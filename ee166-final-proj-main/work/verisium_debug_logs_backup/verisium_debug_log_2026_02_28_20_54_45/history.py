...
# history.py generated at 2026/02/28 15:54:14
# host: vm-hw00
# port: 44295
# launch command: indago -connect dc:vm-hw00.eecs.tufts.edu:37901 -interactive
# #########################################################################
import time, os, sys
if 'self' not in globals():
    ...
    self = VerisiumDebugServer(VerisiumDebugArgs(
        ...
        port=44295,
        extra_args='-connect dc:vm-hw00.eecs.tufts.edu:37901 -interactive'
    ))

# Verisium: Attempting to connect to Verisium server on host: localhost, port: 44295
# Verisium: **************************************************************************************
