...
# history.py generated at 2026/02/23 12:50:13
# host: dell52
# port: 32969
# launch command: indago -connect dc:dell52.eecs.tufts.edu:53653 -interactive
# #########################################################################
import time, os, sys
if 'self' not in globals():
    ...
    self = VerisiumDebugServer(VerisiumDebugArgs(
        ...
        port=32969,
        extra_args='-connect dc:dell52.eecs.tufts.edu:53653 -interactive'
    ))

# Verisium: Attempting to connect to Verisium server on host: localhost, port: 32969
# Verisium: **************************************************************************************
