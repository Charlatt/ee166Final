...
# history.py generated at 2026/03/11 01:37:50
# host: vm-hw05
# port: 46529
# launch command: indago -connect dc:vm-hw05.eecs.tufts.edu:56103 -interactive
# #########################################################################
import time, os, sys
if 'self' not in globals():
    ...
    self = VerisiumDebugServer(VerisiumDebugArgs(
        ...
        port=46529,
        extra_args='-connect dc:vm-hw05.eecs.tufts.edu:56103 -interactive'
    ))

# Verisium: Attempting to connect to Verisium server on host: localhost, port: 46529
# Verisium: **************************************************************************************
