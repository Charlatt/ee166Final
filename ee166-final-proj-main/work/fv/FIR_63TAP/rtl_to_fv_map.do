...
# Generated on: Wed Mar 18 19:31:41 EDT 2026 (Wed Mar 18 23:31:41 UTC 2026)
...
set logfile fv/FIR_63TAP/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/FIR_63TAP -revised fv_map
...
set env(CDN_SYNTH_ROOT) "/usr/cots/cadence/GENUS21/tools.lnx86"
set CDN_SYNTH_ROOT      "/usr/cots/cadence/GENUS21/tools.lnx86"
set env(CW_DIR) "/usr/cots/cadence/GENUS21/tools.lnx86/lib/chipware"
set CW_DIR      "/usr/cots/cadence/GENUS21/tools.lnx86/lib/chipware"
set lec_version_required "21.20249"
if { ($lec_version < $lec_version_required) &&
    [file exists /usr/cots/cadence/GENUS21/tools.lnx86/lib/chipware/old_encrypt_sim]} {
    set env(CW_DIR_SIM) "/usr/cots/cadence/GENUS21/tools.lnx86/lib/chipware/old_encrypt_sim"
    set CW_DIR_SIM      "/usr/cots/cadence/GENUS21/tools.lnx86/lib/chipware/old_encrypt_sim"
} else {
    set env(CW_DIR_SIM) "/usr/cots/cadence/GENUS21/tools.lnx86/lib/chipware/sim"
    set CW_DIR_SIM      "/usr/cots/cadence/GENUS21/tools.lnx86/lib/chipware/sim"
}
...
add_search_path . /usr/cots/cadence/GENUS21/tools.lnx86/lib/tech -library -both
read_library -liberty -both \
    /usr/cots/ip_libraries/tsmc/N16ADFP/stdcell/N16ADFP_StdCell/CCS/N16ADFP_StdCellss0p72vm40c_ccs.lib \
    /usr/cots/ip_libraries/tsmc/N16ADFP/sram/N16ADFP_SRAM/NLDM/N16ADFP_SRAM_ss0p72v0p72vm40c_100a.lib \
    /usr/cots/ip_libraries/tsmc/N16ADFP/stdcell/N16ADFP_StdCell/CCS/N16ADFP_StdCellff0p88v125c_ccs.lib \
    /usr/cots/ip_libraries/tsmc/N16ADFP/sram/N16ADFP_SRAM/NLDM/N16ADFP_SRAM_ff0p88v0p88v125c_100a.lib
...
read_design -enumconstraint -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -sv09 -f ../scripts/rtl_src/macro.vc
elaborate_design -golden -root {FIR_63TAP} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/FIR_63TAP/fv_map.v.gz
elaborate_design -revised -root {FIR_63TAP}
...
#add_name_alias fv/FIR_63TAP/fv_map.singlebit.original_name.alias.json.gz -revised
...
set_system_mode lec
write_compared_points noneq.compared_points.FIR_63TAP.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.FIR_63TAP.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.FIR_63TAP.rtl.fv_map.rpt
