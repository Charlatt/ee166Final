...
# set rm_clock_period 0.475 ;# Target clock period in ns of the macro
# set rm_clock_period 1.0 ;
# set rm_clock_period 0.65
# set rm_clock_period 1.0
set rm_clock_period 1.25
...
set rm_dont_use_list [list *BWP20* *D1* ]
